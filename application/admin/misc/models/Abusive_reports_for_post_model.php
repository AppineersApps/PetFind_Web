...
/**
 * Description of Abusive Reports For Post Model
 * 
 * @category admin
 *            
 * @package misc
 ...
 * @subpackage models 
 *  
 * @module Abusive Reports For Post
 * 
 * @class Abusive_reports_for_post_model.php
 * 
 * @path application\admin\misc\models\Abusive_reports_for_post_model.php
 * 
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Abusive_reports_for_post_model extends CI_Model 
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function __construct() 
    {
        ...
        $this->primary_alias = "arfp_abusive_reports_for_post_id";
    ...
    public function getData($extra_cond = "", $fields = "", $order_by = "", $group_by = "", $limit = "", $join = "No", $having_cond = '', $list = FALSE)
    {
        ...
        $this->db->select("r.vDogsName AS p_post_title");
        ...
        $this->db->select("arfp.iMissingPetId AS arfp_missing_pet_id");
        $this->db->select("u.iUserId AS ron_users_id");
            ...
            $this->db->select("arfp.iAbusiveReportsForMissingPetId AS arfp_abusive_reports_for_post_id");
    ...
    public function getListConfiguration($name = "")
    {
        $list_config = array(
              ...
              "owner_first_name" => array(
                ...
                "table_name" => "missing_pets",
                "table_alias" => "r",
                "field_name" => "vDogsName",
                "source_field" => "",
                "display_query" => "r.vDogsName",
                "entry_type" => "Table",
                "data_type" => "",
                "show_in" => "Both",
                "type" => "textbox",
        ...
        $form_config = array(
             ...
             "owner_first_name" => array(
              ...
              "p_post_title" => array(
                ...
                "arfp_missing_pet_id" => array(
                "name" => "arfp_missing_pet_id",
                "table_name" => "abusive_reports_for_missing_post",
                "table_alias" => "arfp",
                "field_name" => "iMissingPetId",
                "entry_type" => "Table",
