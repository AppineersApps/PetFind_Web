...
<%include file="missing_pet_management_add_strip.tpl"%>
<div class="<%$module_name%>" data-form-name="<%$module_name%>">
<div id="ajax_content_div" class="ajax-content-div top-frm-spacing" >
<input type="hidden" id="projmod" name="projmod" value="missing_pet_management" />
<!-- Page Loader -->
        ...
        <div class="form-row row-fluid " id="cc_sh_r_mobile_no">
            ...
            <div class="form-row row-fluid " id="cc_sh_r_address">
                ...
                <div class="form-row row-fluid " id="cc_sh_r_city">
                    <label class="form-label span3 ">
                        <%$form_config['r_apartmentinfo']['label_lang']%>
                    </label> 
                    <div class="form-right-div  <%if $mode eq 'Update'%>frm-elements-div<%/if%> ">
                        <%if $mode eq "Update"%>
                            <input type="hidden" class="ignore-valid" name="r_apartmentinfo" id="r_apartmentinfo" value="<%$data['r_apartmentinfo']|@htmlentities%>" />
                            <span class="frm-data-label">
                                <strong>
                                    <%if $data['r_apartmentinfo'] neq ""%>
                                        <%$data['r_apartmentinfo']%>
                                    <%else%>
                                    <%/if%>
                                </strong></span>
                            <%else%>
                                <input type="text" placeholder="" value="<%$data['r_apartmentinfo']|@htmlentities%>" name="r_apartmentinfo" id="r_apartmentinfo" title="Apartment Info"  data-ctrl-type='textbox'  class='frm-size-medium'  />
                            <%/if%>
                        </div>
            ...
            <div class="error-msg-form "><label class='error' id='r_claimed_emailErr'></label></div>
                            ...
                            <div class="frm-bot-btn <%$rl_theme_arr['frm_stand_action_bar']%> <%$rl_theme_arr['frm_stand_action_btn']%> popup-footer">
                                ...
                                <%/if%>
                                <%include file="missing_pet_management_add_buttons.tpl"%>
                            </div>
                        </div>
                        <div class="clear"></div>
                    </form>
...
callSwitchToSelf();
<%/javascript%>
<%$this->js->add_js('admin/missing_pet_management_add_js.js')%>

<%$this->js->add_js("admin/custom/missingPetManagement.js")%>
<%if $this->input->is_ajax_request()%>
<%$this->js->js_src()%>
<%/if%> 
<%if $this->input->is_ajax_request()%>
...
<%/if%> 
<%javascript%>
Project.modules.missing_pet_management.callEvents();
<%/javascript%>