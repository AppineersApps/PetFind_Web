...
/**
 * Description of Missing Pet Management Model
 * 
 * @category admin
 *            
 ...
 * 
 * @class missing_pet_management_model.php
 * 
 * @path application\admin\basic_appineers_master\models\Missing_pet_management_model.php
 * 
 * @version 4.4
 *
 * @author CIT Dev Team
...
class Missing_pet_management_model extends CI_Model 
{
    public $table_name;
    public $table_alias;
    public $primary_key;
    ...
    public function __construct() 
    {
        ...
        $this->primary_alias = "r_missing_pet_id";
