...
class User_sign_up_email extends Cit_Controller
{
    ...
    public function create_user($input_params = array())
    {
        ...
        try {
            ...
            if (method_exists($this, "getTermsConditionVersion")) {
                $params_arr["_vtermsconditionsversion"] =
                    $this->getTermsConditionVersion($params_arr["_vtermsconditionsversion"], $input_params);
            }
    ...
    /**
     * Used to process conditions & check user created or not.
     *
     * @param array $input_params input_params array to process condition flow.
     *
     * @return array $block_result returns result of condition block as array.
