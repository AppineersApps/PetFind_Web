...
class Get_message_list extends Cit_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model("basic_appineers_master/fern_user_model");
    }
    ...
    public function get_users_connection_details($user_id = '',$connection_id='',$other_user_id='')
    {
        ...
        try
        {
            ...
            $this->block_result = $this->fern_user_model->get_users_connection_details($user_id,$connection_id,$other_user_id);
