...
class Edit_profile extends Cit_Controller
{
    ...
    public function update_profile($input_params = array())
    {
        ...
        try
        {
            ...
            if (isset($input_params["first_name"])&& ($input_params["first_name"])!='')
            {
                $params_arr["first_name"] = $input_params["first_name"];
            }
            if (isset($input_params["last_name"]) && ($input_params["last_name"])!='')
            {
                $params_arr["last_name"] = $input_params["last_name"];
            }
            if (isset($images_arr["user_profile"]["name"]) && ($images_arr["user_profile"]["name"])!='')
            {
                $params_arr["user_profile"] = $images_arr["user_profile"]["name"];
            }
            if (isset($input_params["apt_suit"]) && ($input_params["apt_suit"])!='')
            {
                $params_arr["apt_suit"] = $input_params["apt_suit"];
            }
            if (isset($input_params["address"]) && ($input_params["address"])!='')
            {
                $params_arr["address"] = $input_params["address"];
            }
            if (isset($input_params["city"]) && ($input_params["city"])!='')
            {
                $params_arr["city"] = $input_params["city"];
            }
            if (isset($input_params["latitude"]) && ($input_params["latitude"])!='')
            {
                $params_arr["latitude"] = $input_params["latitude"];
            }
            if (isset($input_params["longitude"]) && ($input_params["longitude"])!='')
            {
                $params_arr["longitude"] = $input_params["longitude"];
            }
            if (isset($input_params["state_id"]) && ($input_params["state_id"])!='')
            {
                $params_arr["state_id"] = $input_params["state_id"];
            }
            if (isset($input_params["state_name"]) && ($input_params["state_name"])!='')
            {
                $params_arr["state_name"] = $input_params["state_name"];
            }
            if (isset($input_params["zipcode"]) && ($input_params["zipcode"])!='')
            {
                $params_arr["zipcode"] = $input_params["zipcode"];
            }
            $params_arr["_dtupdatedat"] = "NOW()";
            
            if (isset($input_params["mobile_number"]) && ($input_params["mobile_number"])!='')
            {
