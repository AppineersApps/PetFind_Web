                            ...
                            <div class="main-menu f-right d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">    
                                       ...
                                       <li><a href="mailto:petfindmobileapp@gmail.com">Contact</a></li>
                                        <li ><a href="<%$this->config->item('site_url')%>privacy-policy.html" class="nav-link custom-li" style="display: none">Privacy Policy</a></li>
                <li ><a href="<%$this->config->item('site_url')%>terms-conditions.html" class="nav-link custom-li" style="display: none">Terms and Conditions</a></li>
                <li ><a href="<%$this->config->item('site_url')%>end_user_license_agreement.html" class="nav-link custom-li" style="display: none">EULA</a></li>
                <li ><a href="<%$this->config->item('site_url')%>admin" class="nav-link custom-li" style="display: none">Admin</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="row d-flex align-items-center">
                            <div class="col-lg-6 col-md-9 ">
                                <div class="hero__caption">
                                    ...
                                    <h1 data-animation="fadeInUp" data-delay=".6s">The New way of Finding Pets</h1>
                                    <p data-animation="fadeInUp" data-delay=".8s">PetFind uses the power of community to help lost pets find their way back to their loving families</p>
                                    <!-- Slider btn -->
                                   <div class="slider-btns">
                                        <!-- Hero-btn -->
                                        <a data-animation="fadeInLeft" data-delay="1.0s" href="#download-section" class="btn radius-btn">Download</a>
                                        <!-- Video Btn -->
                    ...
                    <div class="container">
                        <div class="row d-flex align-items-center">
                            <div class="col-lg-6 col-md-9 ">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInUp" data-delay=".6s">The New way of Finding Pets</h1>
                                    <p data-animation="fadeInUp" data-delay=".8s">A unique new take on dating apps to make meaningful connections</p>
                                    <!-- Slider btn -->
                                   <div class="slider-btns">
                                        <!-- Hero-btn -->
                                        <a data-animation="fadeInLeft" data-delay="1.0s" href="#download-section" class="btn radius-btn">Download</a>
                        ...
                        <div class="row d-flex align-items-center">
                            ...
                            <div class="col-lg-6 col-md-9 ">
                                <div class="hero__caption">
                                    ...
                                    <p data-animation="fadeInUp" data-delay=".8s">Petfind provides us the splash screen for navigating to the profile page where owner can put his/her information in detail</p>
                                    <!-- Slider btn -->
                                   <div class="slider-btns">
                                        <!-- Hero-btn -->
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="single-features mb-70">
                                    ...
                                    <div class="features-caption" style="padding-top: 5px">
                                        <h3>Logging In</h3>
                                        <p>Create an account to login in and access your information stored safely within the app.
</p>
                                    </div>
                                </div>
                            </div>
                             <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="single-features mb-70">
                                    ...
                                    <div class="features-caption" style="padding-top: 5px">
                                        ...
                                        <p>Click through to see information about the pet such as last seen,physical description, and owner contact information.</p>
                                    </div>
                                </div>
                            </div> 
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="single-features mb-70">
                                    ...
                                    <div class="features-caption" style="padding-top: 5px">
                                       <h3>Tag friends and family</h3>
                                        <p>Anyone added to a missing pet's post will be notified whenever someone interacts with the report.	
                                        </p>
                                    </div>
                                </div>
                            </div>
                             <div class="col-xl-6 col-lg-6 col-md-6">
                                <div class="single-features mb-70">
                                    ...
                                    <div class="features-caption" style="padding-top: 5px">
                                    	<h3>Messaging</h3>
                                        <p>Communication between users is simple and easy with PetFind's in-app messaging</p>
                                    </div>
                                </div>
                            </div>
                        </div>
               ...
               <div class="row d-flex justify-content-center">
                    <div class="col-lg-6">
                        <div class="section-tittle text-center">
                            <h2>How Can We Help You<br>with Pet Find!</h2>
                        </div>
                    </div>
                </div>
                <!-- Section caption -->
                <div class="row">
                    <div class="col-lg-6">
                        <div class=" text-center mb-30">
                           <div class="et_pb_code_inner"><iframe height="315" src="https://www.youtube.com/embed/UT4TD54sdvA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" style="width: 100%;" allowfullscreen></iframe></div>
                           
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="et_pb_text_6 text-center mb-30 video-section-text">
                            <div class="et_pb_text_inner"><h1 style="color:#000!important;font-size: 45px;font-weight: 600;border: unset;">Video</h1>
<p style="color:#000!important;">You're encouraged to find your lovely pets</div>
                        </div>
                    </div> 
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-8">
                        <div class="single-cases-info mb-30">
                            <h3>Pet Find Apps<br> Screenshots</h3>
                            <p>Pet find encourages users to find their loved ones</p>
                        </div>
                    </div>
                    <!-- OwL -->
        ...
        <!-- Available App  Start-->
        <div class="available-app-area" id="download-section">
            <div class="container">
            ...
            <div class="container">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-xl-2 col-lg-3">
                        <div class="say-btn">
                            <a href="mailto:petfindmobileapp@gmail.com" class="btn radius-btn">Contact Us</a>
                        </div>
                    </div>
                </div>
            </div>
