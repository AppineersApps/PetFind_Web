       ...
       try
        {
            ...
            if($input_params['page_code']!="my_pet_list" && $input_params['page_code']!="pet_list"){
                
                $input_params=$this->is_valid_post($input_params);
                $valid_post=$input_params['checkValidPost']['status'];
                // print_r($input_params);exit;
            }
            else{
                $valid_post=1;
            ...
            if ($condition_res["success"] && $valid_post==1)
            {
