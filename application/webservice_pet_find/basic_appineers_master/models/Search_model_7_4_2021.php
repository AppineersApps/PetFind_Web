    ...
    public function get_missing_pet_list($arrResult, &$settings_params)
    {
        ...
        try
        {
            ...
            if(false == empty($arrResult['user_id']))
            {
             ...
             if(false == empty($arrResult['user_id']))
            {
                $this->db->like("i.vDogsName", $arrResult['keyword'],"both"); 
                $this->db->or_like("u.vLastName", $arrResult['keyword'],"both"); 
                $this->db->or_like("u.vFirstName", $arrResult['keyword'],"both"); 
                $this->db->or_like('i.vDogLastSeenStreet', $arrResult['keyword'],"both");
                $this->db->or_like('i.vLastSeenCity', $arrResult['keyword'],"both");
